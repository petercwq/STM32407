...
{	
  ...
  LCD_DisplayString(10,40,16,"Author:Clever");
	LCD_DisplayString(20,70,24,"25 UDP_Server ");
	
	BRUSH_COLOR=BLUE;
	LCD_DisplayString(20,110,16,"IMT407G_IP:192.168.1.240");  //开发板作为UDP服务器时的IP
	LCD_DisplayString(20,130,16,"UDP_Server_PORT:2040 ");     //开发板作为UDP服务器时的端口号
