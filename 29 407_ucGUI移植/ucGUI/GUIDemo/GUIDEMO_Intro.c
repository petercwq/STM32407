...
void GUIDEMO_Intro(void) {
  ...
  GUI_SetFont(&GUI_Font24B_1);
  GUI_DispStringHCenterAt("Illuminati STM32F4  ", xCenter, y += 30);
  GUI_SetColor(GUI_LIGHTRED);
  ...
  GUI_SetColor(GUI_WHITE);
  GUI_DispStringHCenterAt("https://micrium.com", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 40);
...
void GUIDEMO_Intro(void) {
  ...
  GUI_SetFont(&GUI_Font13B_1);
  GUI_DispStringHCenterAt("https://shop125046348.taobao.com", LCD_GET_XSIZE() / 2, LCD_GET_YSIZE() - 50);
  GUIDEMO_Delay(5000);
